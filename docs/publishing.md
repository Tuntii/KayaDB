...
Release binaries are built automatically on `v*` tags via `.github/workflows/release.yml`. See [Releases & Versioning](releases.md) for the full release story (current: `v0.1.45`).
...
3. Merge any release-prep fixes from branches like `tag/v0.1.44` (CI publish script, workflow gates)
