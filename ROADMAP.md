...
| Sequential 2PC only; fail-closed local recovery | No parallel prepare/commit stretch; no durable global decision log; in-doubt → abort on restart |
