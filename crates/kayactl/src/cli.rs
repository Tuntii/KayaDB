...
pub(crate) fn print_usage() {
    ...
    println!();
    println!("INDEX COMMANDS (local engine)");
    println!("  kayactl [--data <dir>] [--json] index create <name> <primary_prefix> [--online] [--extractor whole|prefix|field ...]");
    println!("  kayactl [--data <dir>] [--json] index list");
    println!("  kayactl [--data <dir>] [--json] index drop <name>");
    println!("  kayactl [--data <dir>] [--json] index scan <name> [value_prefix]");
